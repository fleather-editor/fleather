...
* Using [Quill.js Delta](https://quilljs.com/docs/delta) as underlying data format by [Parchment](../parchment/README.md), Fleather is ready for collaborative editing using [OT](https://en.wikipedia.org/wiki/Operational_transformation) (Not provided as a built-in functionality)
